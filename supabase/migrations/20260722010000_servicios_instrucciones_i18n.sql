-- ============================================================
-- Instrucciones de uso del billete / embarque (p.ej. Big Bus app:
-- agregar reserva, activar y mostrar al conductor). Campo i18n
-- reutilizable por cualquier proveedor.
-- ============================================================

alter table public.services
  add column if not exists instrucciones_i18n jsonb not null default '{}'::jsonb;

comment on column public.services.instrucciones_i18n is
  'Cómo usar el billete / embarcar, por idioma: {"es":"…","en":"…"}.';
